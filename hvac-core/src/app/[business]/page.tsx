...
const mockBusinessData = {
  ...
  description: 'Professional HVAC services with over 15 years of experience. Licensed, insured, and committed to your comfort.',
  services: [
    { id: 1, name: 'AC Installation', price: 'Starting at $2,500', description: 'Professional installation of new AC units with warranty' },
    { id: 2, name: 'AC Repair', price: 'Starting at $99', description: 'Fast and reliable AC repair services' },
    { id: 3, name: 'Maintenance', price: 'Starting at $79', description: 'Regular maintenance to keep your system running efficiently' },
  ],
  contact: {
    phone: '(555) 123-4567',
  ...
  reviews: [
    { id: 1, rating: 5, comment: 'Great service! They fixed my AC in no time.', author: 'John D.' },
    { id: 2, rating: 5, comment: 'Professional and efficient service. Highly recommend!', author: 'Sarah M.' },
    { id: 3, rating: 5, comment: 'Best HVAC service in town. Fair pricing and great work.', author: 'Mike R.' },
  ],
  certifications: [
    'EPA Certified',
    'NATE Certified',
          ...
          <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">{business.contact.phone}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">{business.contact.email}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">{business.contact.address}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">{business.contact.hours}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative bg-white p-6 rounded-lg shadow-xl h-full">
                <div className="aspect-w-16 aspect-h-9">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.2156828127!2d-73.987844924987!3d40.757988971389!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes%20Square!5e0!3m2!1sen!2sus!4v1623861234567!5m2!1sen!2sus"
                    allowFullScreen
                  ></iframe>
                </div>
              </div>
